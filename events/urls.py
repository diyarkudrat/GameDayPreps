...
from events.views import EventListView, EventCreateView, EventDetailView, EventDeleteView, EditEventView, EventAttendanceView, AttendanceView
urlpatterns = [
    ...
    path('attendance/<int:pk>/view/', AttendanceView.as_view(), name='attendance-view-page'),
]